...
//Display My Products
let DrawMyProductUi;
(DrawMyProductUi = function(products = []) {
    ...
    let productUi = myProducts.map((item) => {
        ...
        <div class="product-item-desc">
          ...
          <button class='editBtn' onclick='editProduct(${item.id})'> Edit Product </button>
          <button class='editBtn' onclick='deleteProduct(${item.id})'> Delete Product </button>
        </div>
      </div>`;
    });
